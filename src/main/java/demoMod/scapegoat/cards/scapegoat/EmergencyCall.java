...
public class EmergencyCall extends CustomCard {
    public static final String ID = Scapegoat.makeID("EmergencyCall");
    public static final String NAME;
    public static final String DESCRIPTION;
    public static final String IMG_PATH = "cards/emergencyCall.png";

...
public class BloodyCrown extends CustomCard {
    public static final String ID = Scapegoat.makeID("BloodyCrown");
    public static final String NAME;
    public static final String DESCRIPTION;
    public static final String IMG_PATH = "cards/bloodyCrown.png";

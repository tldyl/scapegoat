...
public class BaredSoul extends AbstractMonster {
    ...
    public BaredSoul(String sourceName, float offsetX, float offsetY, int maxHealth) {
        super(sourceName + NAME, ID + UUID.randomUUID().toString(), maxHealth, -8.0F, 10.0F, 180.0F, 229.0F, Scapegoat.getResourcePath("monsters/baredSoul.png"), offsetX, offsetY);
    }
